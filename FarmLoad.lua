...
local function PlayV2()
    ...
    local AllPositions = {
        {110.74224090576172 + math.random(0.2,0.5), 2.244499921798706 + math.random(0.2,0.5), -98.66590118408203 + math.random(0.2,0.5)}, -- Vị trí 2 
        {113.36101531982422 + math.random(0.2,0.5), 2.244499921798706 + math.random(0.2,0.5), 112.03187561035156 + math.random(0.2,0.5)}, -- Vị trí 1
        {-95.7408447265625 + math.random(0.2,0.5), 2.24399995803833 + math.random(0.2,0.5), 89.54883575439453 + math.random(0.2,0.5)},  -- Vị trí 4
        {-76.21514892578125 + math.random(0.2,0.5), 2.24399995803833 + math.random(0.2,0.5), -120.4250259399414 + math.random(0.2,0.5)} -- Vị trí 3
    }
